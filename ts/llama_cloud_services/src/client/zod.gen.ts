...
export const zCheckoutSessionCreatePayload = z.object({
  success_url: z.string().url().min(1),
  cancel_url: z.string().url().min(1),
});
...
export const zDataSource = z.object({
  ...
  version_metadata: z.union([z.object({}), z.null()]).optional(),
  project_id: z.string().uuid(),
});
...
export const zPipelineFileUpdaterConfig = z.object({
  ...
  should_migrate_pipeline_file_to_external_file_id: z
    .boolean()
    .optional()
    .default(false),
});
...
export const zCreateCheckoutSessionApiV1BillingCheckoutSessionPostResponse =
  z.string();

export const zCreateCustomerPortalSessionApiV1BillingCustomerPortalSessionPostResponse =
  z.string();

export const zStripeWebhookApiV1BillingWebhookPostResponse = z.object({});
...
export const zMetronomeWebhookApiV1BillingMetronomeWebhookPostResponse =
  z.object({});
